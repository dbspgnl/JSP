...
public class RegistFarmController extends HttpServlet {
   ...
   String savePath = "C:\\Git_test\\EveryFarm\\WebContent\\resources\\images\\farmimage";
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      if(command.equals("registform")){
         ...
         String wfarm_content01 = multi.getParameter("wfarm_content01")+"/";
         String wfarm_content02 = multi.getParameter("wfarm_content02")+"/";
         String wfarm_content03 = multi.getParameter("wfarm_content03")+"/";
         String wfarm_content04 = multi.getParameter("wfarm_content04");
         ...
         dto.setWfarm_content(wfarm_content01+wfarm_content02+wfarm_content03+wfarm_content04);
